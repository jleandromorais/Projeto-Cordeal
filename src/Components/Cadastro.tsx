...
// Importando o CSS Module que vamos criar
// CORREÇÃO: Ajustando o caminho da importação para ser absoluto
import styles from '/src/Styles/PagCadastro.module.css';
...
// Renomeei para PagCadastro para seguir o padrão do seu projeto
      ...
      <div className={styles.formCard}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.formGrid}>
            ...
            <div className={styles.formColumn}>
              <div className={styles.formGroup}>
                ...
                {/* Trocamos o <Input> por <input> padrão */}
                <input
                  id="nome"
                  name="nome"
                  type="text"
          ...
          <div className={styles.buttonContainer}>
            {/* Trocamos <Button> por <button> padrão */}
            <button
              type="submit"
